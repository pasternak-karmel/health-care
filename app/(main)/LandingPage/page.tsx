...
import { Activity, Settings, LogOut, CheckCircle } from "lucide-react"
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-50">
      {/* Header cohérent avec votre sidebar */}
      <header className="border-b border-slate-200 dark:border-slate-800">
        <div className="container px-4 sm:px-6 py-4 mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
            <Link href="/" className="flex items-center gap-2 text-xl font-bold w-full sm:w-auto justify-center sm:justify-start">
            ...
            <nav className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto justify-center sm:justify-end">
              <Button variant="ghost" asChild className="px-3 sm:px-4 w-full sm:w-auto">
      ...
      <main className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2 space-y-6">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            La solution tout-en-un pour gérer vos rendez-vous médicaux et suivre votre santé.
          </p>
        ...
        <div className="md:w-1/2">
          <div className="bg-slate-200 dark:bg-slate-800 rounded-xl aspect-video flex items-center justify-center">
            <Image
              src="/images/preview-application.png" // Remplacez par le chemin correct de votre image
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            <div className="relative rounded-xl overflow-hidden aspect-[4/3] border border-slate-200 dark:border-slate-700">
              <Image
                src="/images/medecin-patient-rein.png" // À placer dans public/
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              "Votre équipe soignante à vos côtés à chaque étape de votre parcours rénal,
              pour un suivi personnalisé et une meilleure qualité de vie."
            </p>
            ...
            <Button asChild className="mt-4">
              <Link href="/contact">Prendre rendez-vous avec un néphrologue</Link>
            </Button>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                image: "/images/calendar-image.jpeg" // Chemin relatif depuis public/
              },
              {
              ...
              >
                ...
                <p className="text-slate-600 dark:text-slate-400 pl-11">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="bg-slate-900 text-slate-50 dark:bg-slate-950 pt-16 pb-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-400">
                Votre partenaire santé pour un suivi médical personnalisé et simplifié.
              </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-400">
                <li>
                  <Link href="/rendez-vous" className="hover:text-primary transition-colors">
                    Prendre rendez-vous
                  </Link>
                </li>
                <li>
                  <Link href="/medecins" className="hover:text-primary transition-colors">
                    Trouver un médecin
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/urgences" className="hover:text-primary transition-colors">
                    Urgences
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-4">
              ...
              <address className="not-italic text-slate-400 space-y-2">
                ...
                <p>
                  <Link href="tel:+33123456789" className="hover:text-primary transition-colors">
                    +229 01 23 45 67 89
                  </Link>
                </p>
                <p>
                  <Link href="mailto:contact@healthcare.com" className="hover:text-primary transition-colors">
          ...
          {/* Copyright et liens bas */}
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-slate-500">
              © {new Date().getFullYear()} Health Care. Tous droits réservés.
            </p>
            <div className="flex gap-6 mt-4 md:mt-0">
              <Link href="/accessibilite" className="text-sm text-slate-500 hover:text-primary transition-colors">
                Accessibilité
              </Link>
              <Link href="/plan-du-site" className="text-sm text-slate-500 hover:text-primary transition-colors">
                Plan du site
              </Link>
              <Link href="/faq" className="text-sm text-slate-500 hover:text-primary transition-colors">
                FAQ
              </Link>
            </div>
          </div>
